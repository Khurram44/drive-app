export default {
    Green: require('../../assets/Images/greencircle.png'),
    Red: require('../../assets/Images/redcircle.png'),
    Line: require('../../assets/Images/Rectangleline.png'),
    Edit: require('../../assets/Images/editride.png'),
    Rider: require('../../assets/Images/rider.png'),
    Car: require('../../assets/Images/car.png'),
    HLine: require('../../assets/Images/line.png'),
    Flocation: require('../../assets/Images/flocation.png'),
    Tlocation: require('../../assets/Images/tlocation.png'),
