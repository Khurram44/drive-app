        ...
        <LinearGradient colors={['#e5d5b8', '#d4e4f0']} start={{ x: -1, y: 0 }}
            ...
            <ScrollView>
                ...
                <View style={{ marginHorizontal: wp('5%') }}>
                    <Desc>Enter your registered email address below to receive password reset instructions</Desc>
                </View>
                <Formik
                    initialValues={{
                        email: "",
                ...
                <View style={{ bottom: 0, position: 'absolute' }}>
                    <ImageBackground source={Images.Bottom} style={{ width: wp('100%'), height: hp('40%') }} imageStyle={{ resizeMode: 'cover' }} />
                </View>
        </LinearGradient>
    )
}
